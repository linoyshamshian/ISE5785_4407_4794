...
//    }
    ...
    public void testFindIntersections() {
        ...
        assertEquals(gp2, result2.get(0), "Wrong intersection point");
        // TC04: Ray starts after the sphere (0 points)
        ...
        // TC12: Ray starts at sphere and goes outside (0 points)
        assertNull(sphere.findIntersections(new Ray(gp4, v310)), "Ray starts at sphere and goes outside");
        // **** Group 2: Ray's line goes through the center
        ...
        assertEquals(gp1minus10, result5.get(0), "Wrong intersection point");
        ...
        assertEquals(gp1minus10, result6.get(0), "Wrong intersection point");
        ...
        assertEquals(gp1minus10, result7.get(0), "Wrong intersection point");
        // TC25: Ray starts at sphere and goes outside (0 points)
        assertNull(
        ...
        assertNotNull(result8, "Should return one intersection");
        assertEquals(1, result8.size(), "Wrong number of points");
        assertEquals(new Point(1.867,0,0.5), result8.get(0), "Wrong intersection point");
    }
}