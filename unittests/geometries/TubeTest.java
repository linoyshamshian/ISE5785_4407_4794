...
class TubeTest {
    ...
    void testFindIntersections() {
        ...
        assertNotNull(result1, "Expected two intersection points");
        ...
        assertNull(tube.findIntersections(ray2), "Ray outside should not intersect the tube");

        // =============== Boundary Values Tests ==================

        // TC11: Ray is tangent to the tube – no intersection
        Ray ray3 = new Ray(new Point(2, 2, 1), new Vector(0, 0, 1));
        assertNull(tube.findIntersections(ray3), "Tangent ray should not intersect the tube");
        ...
        assertNull(tube.findIntersections(ray4), "Ray starting on surface should not count as intersection");
        ...
        assertNotNull(result5, "Expected only one intersection point");
        assertEquals(1, result5.size(), "Only one point should count (excluding t=0)");
        ...
        assertNull(tube.findIntersections(ray6), "Both intersections behind start – should return null");
        ...
        assertNotNull(result7, "Expected one intersection point");
        assertEquals(1, result7.size(), "Only one intersection in front of ray");
    }
