...
[לצפייה בקוד הפייתון](./python_script.py)

בפרויקט, יצרנו טסט בשם `tigerImage` שקורא את הנתונים מהקובץ ויוצר את הסצנה.

### שלבי העבודה והפלטים:

1. **תמונה ראשונית – מצלמה בזווית לא נכונה:**  
   <img src="./scene_wrong_angle.jpg" width="320" alt="מצלמה בזווית לא נכונה" />

2. **תיקון זווית, אך המצלמה רחוקה מדי:**  
   <img src="./scene_too_far.jpg" width="320" alt="מצלמה רחוקה מדי" />

3. **הפלט הסופי – מצלמה ואובייקטים ממוקמים נכון:**  
   <img src="./scene_final.jpg" width="320" alt="פלט סופי" />
